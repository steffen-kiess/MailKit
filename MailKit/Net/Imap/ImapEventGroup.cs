...
namespace MailKit.Net.Imap {
	...
	{
		class Simple : ImapMailboxFilter
		{
		...
		public static ImapMailboxFilter Selected = new Simple ("SELECTED");
		public static ImapMailboxFilter SelectedDelayed = new Simple ("SELECTED-DELAYED");
		public static ImapMailboxFilter Inboxes = new Simple ("INBOXES");
		public static ImapMailboxFilter Personal = new Simple ("PERSONAL");
		public static ImapMailboxFilter Subscribed = new Simple ("SUBSCRIBED");

		public class Subtree : ImapMailboxFilter
		{
	...
	public abstract class ImapEvent
	{
		...
		public static ImapEvent MessageExpunge = new Simple ("MessageExpunge", true);
		public static ImapEvent FlagChange = new Simple ("FlagChange", true);
		public static ImapEvent AnnotationChange = new Simple ("AnnotationChange", true);

		public static ImapEvent MailboxName = new Simple ("MailboxName", false);
		public static ImapEvent SubscriptionChange = new Simple ("SubscriptionChange", false);
		public static ImapEvent MailboxMetadataChange = new Simple ("MailboxMetadataChange", false);
		public static ImapEvent ServerMetadataChange = new Simple ("ServerMetadataChange", false);
